...
not include works that remain separable from, or merely link (or bind by name) to
...
Derivative Works thereof in any medium, with or without modifications, and in Source or
...
TITLE, NON-INFRINGEMENT, MERCHANTABILITY, or FITNESS FOR A PARTICULAR PURPOSE. You
