...
`DOCS_ENABLED`: Option, um den für den externen Zugriff vorgesehenen Anteil der API zu veröffentlichen. Weitere Informationen im Abschnitt {ref}`h-monitoring-api-monitoring-api`
