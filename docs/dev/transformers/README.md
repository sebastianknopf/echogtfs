...
This directory contains implementation-oriented notes for the concrete transformers used by the datasource layer.

## Contents

- [gtfsrt_service_alerts_transformer.md](gtfsrt_service_alerts_transformer.md): technical notes for the GTFS-Realtime service-alert transformer.
